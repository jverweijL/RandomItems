...
public class RandomAssetsInfoListProvider implements InfoListProvider<AssetEntry> {

	final String KEY = "random-content";
	...
	public List<AssetEntry> getInfoList(
		...
		try {
			...
			while (entries.hasNext()) {
				...
				_log.debug(entry.getClassName() + "|" + entry.getClassPK() + "|" + entry.getEntryId());
			}
	...
	private static final Log _log = LogFactoryUtil.getLog(
			RandomAssetsInfoListProvider.class);
